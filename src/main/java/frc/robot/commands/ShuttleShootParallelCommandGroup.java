...
public class ShuttleShootParallelCommandGroup extends ParallelCommandGroup {
    /** Creates a new SpeakerShootParallelCommandGroup. */
    public ShuttleShootParallelCommandGroup(DriveSubsystem driveSubsystem,
        ...
        addCommands(
                new AimAtCornerCommand(driveSubsystem, xSpeedSupplier, ySpeedSupplier),
                new ShuttleShootCommand(shooterSubsystem)/*
                                                          * ,
