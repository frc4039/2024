...
public class AimAtCornerCommand extends Command {
    ...
    public AimAtCornerCommand(DriveSubsystem driveSubsystem,
    ...
    @Override
    public void execute() {
        double targetangle = driveSubsystem.getTranslationToCorner().getAngle().getRadians();
