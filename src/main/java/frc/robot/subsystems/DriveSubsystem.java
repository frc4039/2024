...
public class DriveSubsystem extends SubsystemBase {
   ...
   */
  public void driveRaw(double xSpeedMetersPerSecond, double ySpeedMetersPerSecond, double rotRadiansPerSecond, boolean fieldRelative) {
    var swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(
        fieldRelative
            ? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedMetersPerSecond, ySpeedMetersPerSecond, rotRadiansPerSecond, Rotation2d.fromDegrees(m_gyro.getYaw().getValue()))
