...
public class PivotToShuttleOverStageCommand extends Command {
    private PivotAngleSubsystem pivot;
    private DriveSubsystem drive;
    private InterpolatingDoubleTreeMap angleEstimator = new InterpolatingDoubleTreeMap();

    /** Creates a new PivotToShuttleOverStage. */
    public PivotToShuttleOverStageCommand(PivotAngleSubsystem pivot, DriveSubsystem drive) {
        this.pivot = pivot;
        this.drive = drive;
    ...
    /*
     * This does NOT work yet, as the AngleEstimator hasn't been adjusted.
     */
    @Override
    public void execute() {
