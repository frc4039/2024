...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 5.2; // dont let ben know that i can make this higher
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDriveWheelFreeSpeedFps = kDriveWheelFreeSpeedRps * 3.28084; //conversion from m/s to ft/s because i got tired of doing the conversion every time ben asked
    //might be able to remove drive speed math - will check at later date
    public static final double kMpsToPercentOutput = kDrivingMotorReduction * 60 / kWheelCircumferenceMeters / kDrivingMotorFreeSpeedRPM; //Multiply by meters per second to get percent output
    ...
    public static final double kTurningEncoderVelocityFactor = (2 * Math.PI) / 30.0; // radians per second used to be /60
